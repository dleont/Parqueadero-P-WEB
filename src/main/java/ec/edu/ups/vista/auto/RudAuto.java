...
public class RudAuto extends javax.swing.JInternalFrame {
   ...
   private Auto auto;
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(txtPlaca1, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel7, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(txtMarca1, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE)
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(btnECancelar, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        try {
             //para actualizar
            auto = autDao.buscar(txtPlaca.getText());
            txtPlaca.setText(auto.getPlaca());
            txtMarca.setText(auto.getMarca());
            txtModelo.setText(auto.getModelo());
            txtAño.setText(Integer.toString(auto.getAño())); //convierte un int en String
            txtPlaca.setEditable(false);
            
            //para aliminar datos
            txtPlaca1.setText(auto.getPlaca());
            txtMarca1.setText(auto.getMarca());
            txtModelo1.setText(auto.getModelo());
            txtAño1.setText(Integer.toString(auto.getAño())); //convierte un int en String
                        
        }catch(java.lang.NullPointerException ex){
            JOptionPane.showMessageDialog(this, "El auto no existe", "Error", JOptionPane.WARNING_MESSAGE);
            txtPlaca.setText("");
            txtPlaca1.setText("");
            txtMarca.setText("");
            txtMarca1.setText("");
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        ...
        if (placa.isEmpty()){
            JOptionPane.showMessageDialog(this, "Ingrese valores para actualizar", "Error", JOptionPane.WARNING_MESSAGE);
        }else{
            ...
            btnLimpiarActionPerformed(evt); //llama al evento limpar
        }
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        try{
            auto.setPlaca(txtPlaca.getText());
            autDao.delete(auto);
            JOptionPane.showMessageDialog(this, "Auto eliminado con éxito", "Mensaje", JOptionPane.INFORMATION_MESSAGE);
            
            btnLimpiarActionPerformed(evt);
            
        }catch(Exception ex){
            JOptionPane.showMessageDialog(this, "El auto no existe", "Error", JOptionPane.INFORMATION_MESSAGE);
        }
